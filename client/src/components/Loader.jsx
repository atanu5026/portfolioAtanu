...
const Loader = () => {
  ...
  const textColor = identity === 'engineering' ? 'text-orange-500' : identity === 'developer' ? 'text-blue-500' : 'text-slate-900 dark:text-white';
    ...
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-zinc-50 dark:bg-black">
      <div className="relative flex items-center justify-center h-24 w-24 mb-8">
        <motion.div
          ...
          className="absolute inset-0 border-t-2 border-r-2 border-slate-300 dark:border-slate-800 rounded-full"
        />
        <motion.div
          animate={{ rotate: -360 }}
