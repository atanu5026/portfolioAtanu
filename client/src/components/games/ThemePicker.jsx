      ...
      <div className="flex gap-4 flex-wrap">
        {themes.map(t => (
          <button
            ...
            className={`flex items-center gap-2 px-3 py-2 border transition-all ${activeTheme === t.id ? 'border-white bg-white/10' : 'border-slate-800 hover:border-slate-600 bg-black'}`}
          >
            <div className="flex">
