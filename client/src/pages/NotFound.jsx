...
const NotFound = () => {
  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-black text-green-500 font-mono flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        ...
        <p className="text-xl md:text-3xl font-bold uppercase tracking-[0.5em] text-slate-900 dark:text-white mt-4">System Failure</p>
      ...
      <div className="z-10 w-full max-w-md bg-white dark:bg-zinc-950 border border-green-900 p-6 shadow-[0_0_20px_rgba(34,197,94,0.1)] relative">
        ...
        <div className="text-sm mb-4">
          <span className="text-slate-500 dark:text-slate-400">Available commands:</span><br/>
          <span className="text-slate-900 dark:text-white">- home</span> (Restore system state)
        </div>
        ...
        <form onSubmit={handleCommand} className="flex gap-2">
          ...
          <input
            ...
            className="flex-1 bg-transparent outline-none text-slate-900 dark:text-white font-bold"
            autoFocus
          />
        </form>
      </div>
      ...
      <button 
        onClick={() => navigate('/')}
        className="fixed bottom-8 text-xs font-mono tracking-widest text-slate-600 hover:text-slate-900 dark:text-white transition-colors"
      >
        [ FORCE REBOOT ]
      </button>
